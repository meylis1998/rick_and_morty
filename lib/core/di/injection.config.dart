...
import 'package:rick_and_morty/core/database/app_database.dart' as _i707;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i707.AppDatabase>(() => injectionModule.database);
    gh.lazySingleton<_i850.DioClient>(() => injectionModule.dioClient);
    gh.lazySingleton<_i361.Dio>(() => injectionModule.dio);
    gh.factory<_i473.CharacterLocalDataSource>(
        () => _i473.CharacterLocalDataSourceImpl(gh<_i707.AppDatabase>()));
    ...
    gh.factory<_i952.CharacterRepository>(() => _i256.CharacterRepositoryImpl(
          gh<_i170.CharacterRemoteDataSource>(),
          gh<_i473.CharacterLocalDataSource>(),
        ));
    gh.factory<_i817.GetCharacters>(
        () => _i817.GetCharacters(gh<_i952.CharacterRepository>()));
    gh.factory<_i598.ToggleFavorite>(
        () => _i598.ToggleFavorite(gh<_i952.CharacterRepository>()));
    gh.factory<_i655.GetFavorites>(
        () => _i655.GetFavorites(gh<_i952.CharacterRepository>()));
    gh.factory<_i314.CharactersBloc>(() => _i314.CharactersBloc(
          gh<_i817.GetCharacters>(),
          gh<_i598.ToggleFavorite>(),
        ));
    gh.factory<_i319.FavoritesBloc>(() => _i319.FavoritesBloc(
          gh<_i655.GetFavorites>(),
          gh<_i598.ToggleFavorite>(),
        ));
    return this;
  }
